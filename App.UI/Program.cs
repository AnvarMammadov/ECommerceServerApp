    ...
    public class Program
    {
        ...
        private static async void ReceiveCallback(IAsyncResult ar)
        {
            ...
            if (msg == "exit")
            {
                ...
                current.Close();
                clientSockets.Remove(current);
                Console.WriteLine("Clietn disconnected");
                return;
            }
            else if(!String.IsNullOrEmpty(msg))
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        var myType = Assembly.GetAssembly(typeof(ProductService)).GetTypes().FirstOrDefault(t=>t.Name==className+"Service");
                        ...
                        { 
                            ...
                            var returnValue = await (objectResponse as Task<Object>);
